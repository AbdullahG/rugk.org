<%-- 
    Document   : hakkimizda
    Created on : Sep 5, 2015, 4:47:44 PM
...
<html>
    ...
    <body>
        ...
        <p>- Araştırma Birimi
            – Organizasyon Birimi
            – Sosyal Ağ ve İnternet Birimi
            – Tanıtım Birimi
            – Eğitim Birimi</p>

        <h3>Proje Grupları</h3>

        <p>- Yazılım Grubu
            – Analiz Tasarım Grubu</p>

        <p>‘’Dünya’nın gördüğü her büyük başarı, önce bir hayaldi. En büyük çınar bir tohumdu, en büyük kuş bir yumurtada gizliydi.” 
            Sloganıyla yoluna devam eden RUGK üniversitemizin en aktif kulüplerinden biri olmayı hedeflemektedir.</p>

        <h3>VİZYONUMUZ & MİSYONUMUZ</h3>

        <p>• Sağlanan eğitim dersleriyle arkadaşlarımızın bilgi birikimini arttırmak,
            • Eğitimin yanında mesleki etkinliklerle saha çalışmalarını tecrübe edindirmek,
