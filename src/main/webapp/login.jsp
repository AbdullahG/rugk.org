...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/cssfor.css">
        <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
        <script src="http://netdna.bootstrapcdn.com/bootstrap/3.0.3/js/bootstrap.min.js"></script>
        <script src="js/jsfor.js"></script>
    </head>
    <body>
        ...
        <div>
            <table align="center">
                <tr>
                    <td>
                        <a href="index.jsp">
                            <img src="photo/ybu_logo.png" alt="asd" width="70" height="70"/>
                        </a>
                    </td>
                    <td>
                    ...
                    <td>
                        <a href="index.jsp">
                            <img src="photo/rugk_logo.png" alt="asd" width="70" height="70"/>
                        </a>
                    </td>
                </tr>
            </table>
        </div>
        <%!String emailForCookie = "", passwordForCookie = ""; %>
        <%
            ...
            if (cookies != null) {
                for (int i = 0; i < cookies.length; i++) {
                    ...
                    if (cookie.getName().equals("email")) {
                        this.emailForCookie = cookie.getValue();
            ...
            <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3"> 
                ...
                <div class="panel panel-default" >
                    <div class="panel-heading">
                        <div class="panel-title text-center">Üye Girişi</div>
                    </div>     

                    <div class="panel-body" >

                        <form name="form" id="form" class="form-horizontal" method="post" action="login.jsp">

                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input id="email" type="text" class="form-control" name="email" value="" placeholder="E-Posta">                                        
                            </div>
        ...
        <%
            if(userBean.getEmail()!=null && userBean.getPassword()!=null)
                userViewBean.setUser(userBean);
            if (userViewBean.getUser()!=null && userViewBean.getUser().getEmail() != null && !userViewBean.getUser().getEmail().equals("") && userViewBean.getUser().getPassword() != null
                    && !userViewBean.getUser().getPassword().equals("")) {
                User userTemp = null;
                if ((userTemp = userViewBean.getRepoService().loginUser(userViewBean.getUser().getEmail(), userViewBean.getUser().getPassword())) != null) {
                    
                    HttpSession sessionObj = request.getSession();
                    sessionObj.setAttribute("userObject", userTemp);
                    if (request.getParameter("remember") != null) {
                        Cookie cookie = new Cookie("email", userTemp.getEmail());
